...
## Project Structure
    ...
    ├── mobileapp_reviewapp23_2  # Django project configurations
...
1. Clone this repo and `cd mobileapp_reviewapp23_2`
...
2. Clone this repo and `cd mobileapp_reviewapp23_2`
